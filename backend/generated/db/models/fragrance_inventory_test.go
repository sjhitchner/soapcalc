...
func testFragranceInventoriesSoftDelete(t *testing.T) {
	t.Parallel()
...
func testFragranceInventoriesQuerySoftDeleteAll(t *testing.T) {
	t.Parallel()
	...
	if rowsAff, err := FragranceInventories().DeleteAll(ctx, tx, false); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testFragranceInventoriesSliceSoftDeleteAll(t *testing.T) {
	t.Parallel()
...
func testFragranceInventoriesQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := FragranceInventories().DeleteAll(ctx, tx, true); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
