...
func testRecipeBatchLyesSoftDelete(t *testing.T) {
	t.Parallel()
...
func testRecipeBatchLyesQuerySoftDeleteAll(t *testing.T) {
	t.Parallel()
	...
	if rowsAff, err := RecipeBatchLyes().DeleteAll(ctx, tx, false); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testRecipeBatchLyesSliceSoftDeleteAll(t *testing.T) {
	t.Parallel()
...
func testRecipeBatchLyesQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := RecipeBatchLyes().DeleteAll(ctx, tx, true); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
