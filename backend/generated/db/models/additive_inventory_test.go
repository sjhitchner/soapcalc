...
func testAdditiveInventoriesSoftDelete(t *testing.T) {
	t.Parallel()
...
func testAdditiveInventoriesQuerySoftDeleteAll(t *testing.T) {
	t.Parallel()
	...
	if rowsAff, err := AdditiveInventories().DeleteAll(ctx, tx, false); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testAdditiveInventoriesSliceSoftDeleteAll(t *testing.T) {
	t.Parallel()
...
func testAdditiveInventoriesQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := AdditiveInventories().DeleteAll(ctx, tx, true); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
