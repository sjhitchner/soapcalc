...
func testLipidInventoriesSoftDelete(t *testing.T) {
	t.Parallel()
...
func testLipidInventoriesQuerySoftDeleteAll(t *testing.T) {
	t.Parallel()
	...
	if rowsAff, err := LipidInventories().DeleteAll(ctx, tx, false); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testLipidInventoriesSliceSoftDeleteAll(t *testing.T) {
	t.Parallel()
...
func testLipidInventoriesQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := LipidInventories().DeleteAll(ctx, tx, true); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
