...
--
-- Name: recipe_additive_additive_id_676ee4ae; Type: INDEX; Schema: public; Owner: soap
--

CREATE INDEX recipe_additive_additive_id_676ee4ae ON public.recipe_additive USING btree (additive_id);
...
--
-- Name: recipe_batch_additive_additive_id_2361c625; Type: INDEX; Schema: public; Owner: soap
--

CREATE INDEX recipe_batch_additive_additive_id_2361c625 ON public.recipe_batch_additive USING btree (additive_id);
...
--
-- Name: recipe_batch_fragrance_fragrance_id_c6546fe6; Type: INDEX; Schema: public; Owner: soap
--

CREATE INDEX recipe_batch_fragrance_fragrance_id_c6546fe6 ON public.recipe_batch_fragrance USING btree (fragrance_id);
...
--
-- Name: recipe_batch_lipid_lipid_id_d8453e8a; Type: INDEX; Schema: public; Owner: soap
--

CREATE INDEX recipe_batch_lipid_lipid_id_d8453e8a ON public.recipe_batch_lipid USING btree (lipid_id);
...
--
-- Name: recipe_fragrance_fragrance_id_0dcf3ef6; Type: INDEX; Schema: public; Owner: soap
--

CREATE INDEX recipe_fragrance_fragrance_id_0dcf3ef6 ON public.recipe_fragrance USING btree (fragrance_id);
...
--
-- Name: recipe_lipid_lipid_id_76650ba8; Type: INDEX; Schema: public; Owner: soap
--

CREATE INDEX recipe_lipid_lipid_id_76650ba8 ON public.recipe_lipid USING btree (lipid_id);
...
--
-- Name: lye_inventory lye_inventory_lye_id_5e9da65f_fk_lye_inventory_id; Type: FK CONSTRAINT; Schema: public; Owner: soap
--

ALTER TABLE ONLY public.lye_inventory
    ADD CONSTRAINT lye_inventory_lye_id_5e9da65f_fk_lye_inventory_id FOREIGN KEY (lye_id) REFERENCES public.lye_inventory(id) DEFERRABLE INITIALLY DEFERRED;
